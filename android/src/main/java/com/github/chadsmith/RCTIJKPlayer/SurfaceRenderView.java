...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(mMeasureHelper.getMeasuredWidth(), MeasureSpec.AT_MOST),
                MeasureSpec.makeMeasureSpec(mMeasureHelper.getMeasuredHeight(), MeasureSpec.AT_MOST));
